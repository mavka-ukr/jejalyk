...
public:
  ...
  virtual void enterFromto_string(MavkaParser::Fromto_stringContext * /*ctx*/) override { }
  virtual void exitFromto_string(MavkaParser::Fromto_stringContext * /*ctx*/) override { }
