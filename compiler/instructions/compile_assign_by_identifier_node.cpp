...
NodeCompilationResult* compile_assign_by_identifier_node(
  ...
  if (assign_by_identifier_node->op == "=") {
    ...
    return compile_assign_by_identifier_node(new_assign_by_identifier_node,
                                             scope, options, state);
  }
}
}  // namespace jejalyk
