...
NodeCompilationResult* compile_arithmetic_node(
  ...
  if (arithmetic_node->op == "+") {
    node_compilation_result->result = MAVKA_ADD + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else if (arithmetic_node->op == "-") {
    node_compilation_result->result = MAVKA_SUB + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else if (arithmetic_node->op == "*") {
    node_compilation_result->result = MAVKA_MUL + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else if (arithmetic_node->op == "/") {
    node_compilation_result->result = MAVKA_DIV + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else if (arithmetic_node->op == "%") {
    node_compilation_result->result = MAVKA_MOD + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else if (arithmetic_node->op == "//") {
    ...
    node_compilation_result->result = MAVKA_POW + "(" + compiled_left->result +
                                      "," + compiled_right->result + "," +
                                      diName + ")";
  } else {
