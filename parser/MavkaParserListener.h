...
public:
  ...
  virtual void enterFromto_middle(MavkaParser::Fromto_middleContext *ctx) = 0;
  virtual void exitFromto_middle(MavkaParser::Fromto_middleContext *ctx) = 0;

  virtual void enterFromto_symbol(MavkaParser::Fromto_symbolContext *ctx) = 0;
  virtual void exitFromto_symbol(MavkaParser::Fromto_symbolContext *ctx) = 0;
