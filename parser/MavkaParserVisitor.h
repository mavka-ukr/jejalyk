...
public:
   ...
   */
    ...
    virtual std::any visitFromto_middle(MavkaParser::Fromto_middleContext *context) = 0;

    virtual std::any visitFromto_symbol(MavkaParser::Fromto_symbolContext *context) = 0;
    ...
    virtual std::any visitAssign_value(MavkaParser::Assign_valueContext *context) = 0;
